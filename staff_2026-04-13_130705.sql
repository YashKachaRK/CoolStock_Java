...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;insert into `staff` (`email`, `full_name`, `id`, `is_active`, `joined_date`, `password_hash`, `phone`, `role`, `staff_key`) values ('amit@coolstock.in', 'Amit Sharma', 1, 1, '2026-04-10 13:26:03', '$2a$10$8.UnVuG9HHgffUDAlk8KnO2yfGUuU.A9/y.uN/qP1yZ.y.y.y.y.y', '9800111111', 'Manager', 'STAFF-1');
