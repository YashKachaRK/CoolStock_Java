...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;insert into `products` (`category`, `created_at`, `description`, `flavor`, `id`, `is_active`, `name`, `pcs_per_box`, `price`, `product_code`, `stock`) values ('Tubs', '2026-04-10 13:26:03', 'Classic creamy vanilla in wholesale 1kg tubs.', 'Vanilla', 1, 1, 'Vanilla Paradise Tub', 6, '120.00', 'PROD-101', 442);
