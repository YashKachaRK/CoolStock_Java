...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;insert into `orders` (`cashier_id`, `customer_id`, `delivery_boy_id`, `delivery_priority`, `id`, `order_date`, `order_number`, `payment_status`, `status`, `total_amount`) values (NULL, 1, 3, 'Regular', 1, '2026-03-01 10:30:00', 'ORD-10001', 'Unpaid', 'Delivered', '4500.00');
