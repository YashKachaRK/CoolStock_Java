CREATE TABLE `job_applications` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;insert into `job_applications` (`applied_at`, `cover_letter`, `email`, `full_name`, `id`, `phone`, `role`, `status`) values ('2026-04-07 10:30:04', 'I want job ', 'ykacha243@rku.ac.in', 'YASH KACHA', 1, '78630 69413', 'Manager', 'ACCEPTED');
